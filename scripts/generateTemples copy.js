...
// -------------------------------------
// Helper: Convert "YYYY, Month, Day" → Date()
// -------------------------------------
function parseTempleDate(dateString) {
  // Example: "2005, August, 7"
...
// -------------------------------------
// Render Function (creates temple cards)
// -------------------------------------
...
function filterTemples(mode) {
  let filtered = [...temples]; // fresh copy every time
